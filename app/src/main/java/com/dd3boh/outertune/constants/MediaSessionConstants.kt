...
object MediaSessionConstants {
    ...
    const val ACTION_TOGGLE_START_GLOBAL_RADIO = "TOGGLE_START_GLOBAL_RADIO"
...
//edgar    val CommandToggleStartGlobalRadio = SessionCommand(ACTION_TOGGLE_START_GLOBAL_RADIO, Bundle.EMPTY)
